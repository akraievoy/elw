 ...
 * @version $Id: RegisterControl.java,v 1.16 2006/12/28 10:38:57 Anton S. Kraievoy Exp $
 */

public class RegisterControl {
    private static final Logger log = Logger.getLogger(RegisterControl.class.getName());
